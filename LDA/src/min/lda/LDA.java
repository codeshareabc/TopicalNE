...
//    	BufferedReader br = new BufferedReader(new FileReader(URLs.vocabulary));
    	BufferedReader br = new BufferedReader(new FileReader("C:\\MountedDisk\\git\\workspace_python\\TopicalNE\\datasets\\cora\\cora_vocabulary.txt"));
    	String line = "";
    	String[] params = null;
    	...
    	br.close();
    	br = new BufferedReader(new FileReader("C:\\MountedDisk\\git\\workspace_python\\TopicalNE\\datasets\\cora\\LDA topics\\cora_phi.txt"));
    	int linecount = 0;
    	String[] probs = null;
...
//    	String thetaFile = savePath + "\\theta.txt";
//    	String phiFile = savePath + "\\phi.txt";
